...
from memory_lsasecrets.hive.regf import filetime_to_utc
from memory_lsasecrets.hive.values import decode, type_name
...
class KeyNode:
    ...
    def parse(cls, payload: bytes, offset: int, allocated: bool = True) -> "KeyNode":
        ...
        class_len = struct.unpack_from("<H", payload, 0x4A)[0]
        ...
        return cls(offset, flags, filetime_to_utc(ft), parent, n_sub, sub_list,
                   n_val, val_list, sec, klass, name, allocated, class_len)
