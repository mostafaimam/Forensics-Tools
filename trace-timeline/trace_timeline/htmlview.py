...
from trace_timeline.model import Event
...
<footer>trace-timeline &middot; __N__ events &middot; tags stored in this browser only</footer>
<script>
const DATA = __DATA__;
const KEY = "trace-timeline:" + (location.pathname||"tl");
let tags = {};
