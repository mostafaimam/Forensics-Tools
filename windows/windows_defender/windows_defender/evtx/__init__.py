from windows_defender.evtx.headers import (
    ChunkHeader,
    EvtxError,
    FileHeader,
    iter_chunks,
...
from windows_defender.evtx.record import EventRecord, parse_record
...
def parse_evtx(data: bytes):
    ...
    from windows_defender.evtx.headers import FILE_HEADER_SIZE
