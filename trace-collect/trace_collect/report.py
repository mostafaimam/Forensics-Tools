...
MANIFEST_NAME = "trace-collect_manifest.csv"
ERRORS_NAME = "trace-collect_errors.csv"
SUMMARY_NAME = "trace-collect_summary.txt"
RUNINFO_NAME = "trace-collect_runinfo.json"
...
class Report:
    ...
    def finalise(self, extra: dict | None = None) -> str:
        ...
        lines = [
            "trace-collect collection summary",
            "=" * 40,
