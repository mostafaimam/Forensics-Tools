...
from browser_downloads import __version__, tracelib
from browser_downloads.analyze import analyze
from browser_downloads.output import COLUMNS, render, row
...
def main(argv: list[str] | None = None) -> int:
    ...
    ctx = tracelib.context(a, "browser_downloads", __version__)
    try:
