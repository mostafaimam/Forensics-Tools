...
from browser_bookmarks import __version__, tracelib
from browser_bookmarks.analyze import analyze
from browser_bookmarks.output import COLUMNS, render, row
...
def main(argv: list[str] | None = None) -> int:
    ...
    ctx = tracelib.context(a, "browser_bookmarks", __version__)
    try:
