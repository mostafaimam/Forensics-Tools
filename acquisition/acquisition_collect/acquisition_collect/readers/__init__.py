...
from acquisition_collect.readers.base import CollectedStream, Reader, ReadError
from acquisition_collect.readers.live import LiveReader
...
def get_reader(kind: str, **kw):
    ...
    if kind == "vss":
        from acquisition_collect.readers.vss import VssReader
